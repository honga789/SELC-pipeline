...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str, default="Agnews-12k-train-clf", help='Name of the dataset.')
    parser.add_argument('--csv_path', type=str, default="./Data/Agnews-12k-train/ag_news_12k.csv", help='Path to the CSV file.')
    parser.add_argument('--feather_path', type=str, default="./Data/Agnews-12k-train/agnews-12k-train-bert-noise/agnews-12k-train_clf.feather", help='Path to the feather file.')
