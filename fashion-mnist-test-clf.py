...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str, default="Fashion-mnist-test-clf", help='Name of the dataset.')
    parser.add_argument('--csv_path', type=str, default="./Data/Fashion-MNIST-test/fashion_mnist.csv", help='Path to the CSV file.')
    parser.add_argument('--feather_path', type=str, default="./Data/Fashion-MNIST-test/fashion-mnist-test-clip-b16-noise/fashion-mnist-test_clf.feather", help='Path to the feather file.')
    parser.add_argument('--data_column', type=str, default="image_name", help='Column name for data identifiers.')
    parser.add_argument('--label_column', type=str, default="label", help='Column name for labels.')
    parser.add_argument('--image_dir', type=str, default="./Data/Fashion-MNIST-test/images", help='Directory containing images.')
    ...
    # 0. Tính Error Rate ban đầu
    initial_errors = np.sum(noisy_labels != clean_labels)
    initial_error_rate = initial_errors / len(clean_labels) * 100
    ...
    logging.info(f"Initial Error Rate: {initial_errors}/{len(clean_labels)} = {initial_error_rate:.2f}%")
