...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str, default="Fashion-mnist-test-llm", help='Name of the dataset.')
    parser.add_argument('--csv_path', type=str, default="./Data/Fashion-MNIST-test/fashion_mnist.csv", help='Path to the CSV file.')
    parser.add_argument('--feather_path', type=str, default="./Data/Fashion-MNIST-test/fashion-mnist-test-clip-b16-noise/fashion-mnist-test_LLM.feather", help='Path to the feather file.')
