...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str, default="CIFAR-10-train50k_sym40", help='Name of the dataset.')
    parser.add_argument('--csv_path', type=str, default="./Data/Cifar10-train/labels.csv", help='Path to the CSV file.')
    parser.add_argument('--feather_path', type=str, default="./Data/Cifar10-train/cifar10-train-clip-b16-noise/cifar10-train_sym40.feather", help='Path to the feather file.')
    ...
    parser.add_argument('--image_dir', type=str, default="./Data/Cifar10-train/images", help='Directory containing images.')
    ...
    if es is None:
        ...
        estimated_es_val, _ = estimate_es_m1(
            ...
            max_scan_epochs=80, lr=scan_lr, optimizer_name=scan_op, weight_decay=1e-3,
